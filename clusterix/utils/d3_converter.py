...
class D3Converter():
    ...
    def get_d3_json(self, linkage, root_name):
        ...
        self.add_node(tree, d3_dendro)
        self.label_tree(d3_dendro["children"][0])
